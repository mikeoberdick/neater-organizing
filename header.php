	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 text-center">
				<a href="services-pricing-guide/"><span class = "h5 subheader">View Our Services And Pricing Guide</span><img class = "ml-2" src = "<?php echo get_stylesheet_directory_uri() . '/img/long_arrow.png'; ?>"></a>
			</div><!-- .col-sm-12 -->
		</div><!-- .row -->
	</div><!-- .container -->
</div><!-- #notificationBar -->
